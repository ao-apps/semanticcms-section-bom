 ...
 * along with semanticcms-section-bom.  If not, see <https://www.gnu.org/licenses/>.
 */
...
def upstreamProjects = [
	...
	// BOM
	'all', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-section-all</artifactId>
